        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>{{ $title }}</h5>
                        <span>Gerenciamento de Origens (Lead)</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('painel.sources.index') }}">Origens</a>
                        </li>
    ...
    <script>
        $(function() {
            ...
            $('#fullwindowModal').on('hide.bs.modal', function() {
                ...
                $('#fullwindowModalLabel').text('Adicionar Origem');

                $('#formSource').trigger('reset')
                    .attr('action', "{{ route('painel.sources.store') }}")
