...
<head>
    ...
    <title>
        {{ isset($title) ? $title . ' - ' . config('app.name', 'Mentora CRM') : config('app.name', 'Mentora CRM') }}
    </title>
            ...
            <footer class="footer">
                <div class="w-100 clearfix">
                    ...
                    <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Criado com <i
                            class="fa fa-heart text-danger"></i> por <a href="https://mentorasolucoes.com.br/"
                            class="text-dark" target="_blank">Mentora Soluções</a></span>
                </div>
            </footer>
        </div>
    </div>
